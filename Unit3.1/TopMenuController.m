...
//  Unit3.1
//
//  Created by fukutarohori on 07/06/12.
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        if (self = [super initWithStyle:UITableViewStylePlain]){
            ...
            self.title = @"トップメニュー！";
            //表示するデータを作成
            //_items = [[NSMutableArray alloc] initWithObjects:@"1",@"2", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    if (!cell){
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewStylePlain reuseIdentifier:@"simple-cell"];
    }
